...
public class MenuManager {
    public static void main(String[] args) {
        ...
        // 将菜单对象转换成json字符串
        //有问题：主菜单项多了一个type
        String jsonMenu = JSON.toJSON(getTestMenu()).toString();
...
//        ApiConfigKit.setThreadLocalAppId(appId);
    ...
    private static Menu getTestMenu() {
        ...
        btn23.setName("我的设备");
        btn23.setType("view");
        btn23.setUrl("https://hw.weixin.qq.com/devicectrl/panel/device-list.html?appid=");
        ...
        btn34.setName("我的博客");
        btn34.setType("view");
        btn34.setUrl("http://www.ihih.club");
